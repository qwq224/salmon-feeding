...
const KnowledgeBase = {
  ...
  getKnowledgeSources() {
    return [
      ...
      { id: 2, title: '高温修正公式', source: '水产养殖通用规则', type: '经验公式' },
      { id: 3, title: '溶氧-摄食率关系', source: '鲤科鱼类实验数据', type: '实验研究' },
      { id: 4, title: '三文鱼养殖水质标准', source: 'CN103766250A 专利', type: '专利文献' },
      { id: 5, title: 'FCR 饲料转化率定义', source: 'FAO 水产养殖手册', type: '国际标准' },
      { id: 6, title: '四定三看投喂原则', source: '中国传统养鱼经验', type: '传统经验' },
    ];
  },
};
