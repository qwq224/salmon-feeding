...
🌐 **在线体验**: 
- 🆕 阿里云 ECS: http://121.40.98.11:3456 （2026-07-28 迁移）
- Render (备用): https://salmon-feeding.onrender.com
...
| 📚 **知识库** | 90篇文档 · 21万字 · BM25+向量混合检索 · 论文/标准/手册 |
...
- **AI**: DeepSeek (主) + Claude API 备用 + Transformers.js (可选)
- **检索**: BM25 关键词 + 384维向量 + RRF 融合
- **分词**: 中文 bigram + 英文单词混合
- **存储**: SQLite (Node 24 内置) + 分片向量库
